...
function xmldb_local_aiassistant_install() {
    ...
    $knowledge = [
        ...
        ['category' => 'resources', 'question_pattern' => 'No puedo abrir un video', 'answer' => 'Asegúrate de tener una buena conexión a internet y que tu navegador esté actualizado. Intenta recargar la página.'],
